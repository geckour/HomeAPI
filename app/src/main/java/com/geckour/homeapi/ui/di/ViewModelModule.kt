...
val viewModelModule = module {
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                if (response.code() == 401) {
                    ...
                    refreshToken?.let {
                        val name = if ((androidApplication() as App).isWiFiConnected) AUTH_SERVICE_WIFI else AUTH_SERVICE_MOBILE
    ...
    viewModel { LoginViewModel(androidApplication() as App, get(), get(), get(named(AUTH_SERVICE_WIFI)), get(named(AUTH_SERVICE_MOBILE))) }

    viewModel { MainViewModel(androidApplication() as App, get(), get(named(API_SERVICE_WIFI)), get(named(API_SERVICE_MOBILE))) }
}